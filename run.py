...
parser.add_argument('--model_id', type=str, required=True, default='LLMTSES-ERA5-96-48-96',help='model id')
parser.add_argument('--model', type=str, required=True, default='LLMTSES',
                    help='model name, options: [Autoformer, Transformer, TimesNet]')
# data loader
parser.add_argument('--data', type=str, required=True, default='QBO', help='dataset type')
parser.add_argument('--number_variable', type=int,default=9, help='number of variable')

parser.add_argument('--root_path', type=str, default='./datasets/ERA5/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='ERA5-Singapore (48698)(0.50.751)N104E-six points-10-20-30-50-70-100 pressure1.csv', help='data file')
